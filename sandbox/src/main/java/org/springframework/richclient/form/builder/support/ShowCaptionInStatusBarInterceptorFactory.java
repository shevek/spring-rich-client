...
/**
 * If a form property has a caption defined in the messages.properties file the following
 * happens: When component receives focus, the value is shown in the statusbar, when the

...
public class TestableXmlSettingsReaderWriter implements XmlSettingsReaderWriter {
	RootXmlSettings lastWritten;

	private RootXmlSettings readNext;
	...
	public RootXmlSettings getLastWritten() {
		return lastWritten;
	}

	public void setReadNext(RootXmlSettings readNext) {

 ...
 */
public class EnumComboBoxBinder implements Binder {

    public Binding bind(FormModel formModel, String formPropertyPath, Map context) {        
        return new EnumComboBoxBinding(formModel, formPropertyPath, context);
    }

    public Binding bind(JComponent control, FormModel formModel, String formPropertyPath, Map context) {        
        return new EnumComboBoxBinding((JComboBox) control, formModel, formPropertyPath, context);
    }
}
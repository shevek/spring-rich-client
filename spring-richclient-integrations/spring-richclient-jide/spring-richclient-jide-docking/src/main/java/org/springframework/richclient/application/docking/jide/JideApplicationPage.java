...
import org.springframework.richclient.application.docking.jide.editor.EditorComponentPane;
import org.springframework.richclient.application.docking.jide.editor.EditorDescriptor;
import org.springframework.richclient.application.docking.jide.editor.WorkspaceView;
...
import org.springframework.richclient.application.docking.jide.view.JideViewDescriptor;
...
public class JideApplicationPage extends DefaultApplicationPage{
	...
	public View showView(String viewDescriptorId){
        if (logger.isDebugEnabled())
        {
            logger.debug("Adding view for " + viewDescriptorId);
        }
        View v = super.showView(viewDescriptorId);
        registerPageComponent(viewDescriptorId);
        return v;
    }

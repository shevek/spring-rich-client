 ...
 * 
 * <p>As this class delegates to a <code>PropertyAccessor</code> for property access,
 * the support for type resolution and <b>nested properties</b>
 * depends on the implementation of the <code>PropertyAccessor</code>
 *   
...
public abstract class AbstractPropertyAccessStrategy implements MutablePropertyAccessStrategy {
    ...
    /**
     * Creates a new instance of AbstractPropertyAccessStrategy that will provide access
     * to the properties of the provided object.
     * 
    ...
    /**
     * Creates a new instance of AbstractPropertyAccessStrategy that will provide access
     * to the object contained by the provided value model.  
     * 
     * @param domainObjectHolder value model that holds the object to 
    ...
    /**
     * Creates a child instance of AbstractPropertyAccessStrategy that will delegate to its 
     * parent for property access.
     * 
     * @param parent AbstractPropertyAccessStrategy which will be used to provide property access
    ...
    public abstract MutablePropertyAccessStrategy getPropertyAccessStrategyForPath(String propertyPath) throws BeansException;

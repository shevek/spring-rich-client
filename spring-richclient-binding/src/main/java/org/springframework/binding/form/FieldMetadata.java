...
public interface FieldMetadata extends PropertyChangePublisher {
     ...
     * display/behaviour to reflect the new state. e.g. When this property becomes 
     ...
     * <li>It is marked as read only by a call to the setReadOnly method of this class</li>
     * <li>It is marked as read only by a call to the setReadOnly method of the metadata of any ancestor
     ...
     * <li>It has not been marked as disabled by a call to the setEnabled method of this class</li>
     * <li>It has not been marked as disabled by by a call to the setEnabled method of the 

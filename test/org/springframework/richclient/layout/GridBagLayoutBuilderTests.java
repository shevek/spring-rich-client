...
//    }
    ...
    public void testAppendLabeledField() throws Exception {
        ...
        builder.appendLabeledField(new JLabel("0"), new JLabel("3"),
            LabelOrientation.TOP, 1, 2, true, false);
        ...
        check(layout.getConstraints(comps[0]), 0, 0, 1, 1);
        check(layout.getConstraints(comps[1]), 1, 0, 1, 1);
        check(layout.getConstraints(comps[2]), 2, 0, 2, 1);
        check(layout.getConstraints(comps[3]), 0, 1, 1, 2);
        check(layout.getConstraints(comps[4]), 1, 1, 3, 1);
        check(layout.getConstraints(comps[5]), 1, 2, 3, 1);
        check(layout.getConstraints(comps[6]), 0, 3, 3, 1);
        check(layout.getConstraints(comps[7]), 3, 3, 1, 1);
    }

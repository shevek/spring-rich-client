...
public class ListBinderTests extends AbstractBindingTests {
    ...
    protected String setUpBinding() {
        ...
        selectableItems = Arrays.asList(new Object[] {
            new Item("A"),
            new Item("B"),
            new Item("C"),
            new Item("D"),
        ...
        context.put(ListBinder.COMPARATOR_KEY, new PropertyComparator("name"));
    ...
    protected void setupBinding(final String formPropertyPath)
    {
      ...
      final Class selectionPropertyType = fm.getMetadataAccessStrategy().getPropertyType(formPropertyPath);
    ...
    public void testNoInitialMultipleSelection() {
      multipleSelectionBinding();
      assertEquals(ListSelectionModel.MULTIPLE_INTERVAL_SELECTION, c.getSelectionMode());
      assertTrue("Expected empty selection in list.", c.getSelectedValues() == null || c.getSelectedValues().length  == 0);
    }
    ...
    public void testInitialMultipleSelection() {
      setupMultipleSelectionBinding();
      vm.setValue(Arrays.asList(new Object[] {
          new Item("E"),
          new Item("B")
      }));
      doMultipleSelectionBinding();
    ...
    public void testInitialForcedSingleSelection() {
      setupMultipleSelectionBinding();
      context.put(ListBinder.SELECTION_MODE_KEY, "SINGLE_SELECTION");
      final List originalList = Arrays.asList(new Object[] {
          new Item("E"),
          new Item("B")
      });
    ...
    public void testMultipleSelectionTracksSelectionHolder() {
      ...
      List original = Arrays.asList(new Object[] {
          new Item("B"),
          new Item("C")
      });
      ...
      original = Arrays.asList(new Object[] {
         new Item("A"),
         new Item("B"),
         new Item("D"),
         new Item("E")
    ...
    static class Item
    {
      ...
      {
        if (this == frameKey) return true;
        if (frameKey == null || getClass() != frameKey.getClass()) return false;

        final Item item = (Item) frameKey;

        if (name != null ? !name.equals(item.name) :
            item.name != null) return false;

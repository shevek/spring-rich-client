...
public class ShowPageMenu extends CommandGroup implements ApplicationWindowAware {
     ...
     * that will each show a given page when executed. The collection of 'show page' commands will
     * be determined by querying the {@link PageDescriptorRegistry} retrieved from

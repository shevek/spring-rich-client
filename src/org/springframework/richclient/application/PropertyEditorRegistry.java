...
public interface PropertyEditorRegistry {
    ...
    /**
     * Set the class to use for the {@link PropertyEditor} of classes of
     * a given type.
     *
     * @param typeClass           the type of class to use the property editor for
     * @param propertyEditorClass the class to create a PropertyEditor from
     */
    ...
    /**
     * Set the class to use for the {@link PropertyEditor} for the given
     * class property.
     *
     * @param objectType          the class that the property is for
     * @param propertyName        the name of the property
     * @param propertyEditorClass the class to create a PropertyEditor from
     */
    public void setPropertyEditor(Class objectType, String propertyName,
                                  Class propertyEditorClass);

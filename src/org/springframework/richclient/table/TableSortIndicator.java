...
public class TableSortIndicator {
    ...
    public TableSortIndicator(JTable table, Icon ascendingIcon,
            Icon descendingIcon) {
    ...
    private void initHeaderRenderers() {
        for (int i = 0; i < table.getColumnCount(); i++) {
            ...
            col.setPreferredWidth(TableUtils.calculatePreferredColumnWidth(
                    table, col));
    ...
    private static final class HeaderRenderer extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table,
                Object value, boolean iSelected, boolean hasFocus, int row,
                int column) {
                        ...
                        try {
                            ...
                            JOptionPane
                                    .showMessageDialog(
                                            ...
                                            "Maximum number of sort levels reached.",
                                            "Table Sorter",
    ...
    private void removeRendererIcons() {
        ...
        for (int i = 0; i < colModel.getColumnCount(); i++) {
            HeaderRenderer rend = (HeaderRenderer)colModel.getColumn(i)
                    .getHeaderRenderer();
            rend.setIcon(null);
        }
    }

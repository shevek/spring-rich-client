...
/**
 * LayoutBuilders exist to make it easier to do component layouts.  Typical
 * usage is to create an instance of the builder, add components to it,
 * the call the builder's {@link #getPanel()} method.
 */

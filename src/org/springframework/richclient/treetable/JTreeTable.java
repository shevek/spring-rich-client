package org.springframework.richclient.treetable;
...
public class JTreeTable extends JTable {
    ...
    public class TreeTableCellRenderer extends JTree implements TableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected,
             ...
             * else if (hasFocus) { highlightBorder =
             * UIManager.getBorder("Table.focusCellHighlightBorder"); if
             * (isCellEditable(row, column)) { background =
             * UIManager.getColor("Table.focusCellBackground"); foreground =
                ...
                if (me.getModifiers() == 0 || me.getModifiers() == InputEvent.BUTTON1_MASK) {
                    for (int counter = getColumnCount() - 1; counter >= 0; counter--) {
                        if (getColumnClass(counter) == TreeTableModel.class) {
                            MouseEvent newME = new MouseEvent(JTreeTable.this.tree, me.getID(), me.getWhen(), me
                                    .getModifiers(), me.getX() - getCellRect(0, counter, true).x, me.getY(), me

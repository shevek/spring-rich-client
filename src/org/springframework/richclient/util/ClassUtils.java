...
public class ClassUtils {
    ...
    public static String getClassFieldNameWithValue(Class clazz, Object value) {
        ...
        for (int i = 0; i < fields.length; i++) {
            ...
            try {
                ...
                if (value.equals(constant)) { return clazz.getName() + "."
                        + field.getName(); }
            }
            catch (Exception e) {
                e.printStackTrace();
    ...
    public static Class getPropertyClass(Class parentClass, String propertyName)
        ...
        if (getterMethod != null) { return getterMethod.getReturnType(); }

        final Method setterMethod = getSetterMethod(parentClass, propertyName);
        if (setterMethod != null) { return setterMethod.getParameterTypes()[0]; }

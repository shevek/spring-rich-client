 ...
 * </li>
 * <li>When an object is restored, an appropriate class for an object might
 * not be available. It must be possible to skip an object in this case.</li>
...
public interface Memento {
	 ...
	 * @see #getID()
	 */
    public static final String TAG_ID = "memento.internal.id";
	 ...
	 * is stored in the child memento (using a special reserved key, <code>TAG_ID</code>)
	 * and can be retrieved using <code>getId</code>.
	 * <p>
	 * The <code>getChild</code> and <code>getChildren</code> methods are
	 * used to retrieve children of a given type.
	 * </p>
	 ...
	 * @param key
	 *            the key
	 * @return the value, or <code>null</code> if the key was not found or
	 *         was found but was not a floating point number
	 */
	 ...
	 *            the key
	 * @return the value, or <code>null</code> if the key was not found or
	 *         was found but was not an integer
	 */
	 ...
	 * are replaced. Each memento is allowed only one text node.
	 * 
	 * @param data

...
public class CommandGroup extends AbstractCommand {
	...
	private AbstractCommand findCommandMember(String commandId) {
		...
		logger.warn("No command with id '" + commandId + "' is nested within this group (" + getId() + "); returning null");
		return null;
	}
	...
	private void bindMembers(Object owner, Container memberContainer, Object controlFactory,
		...
		getMemberList().bindMembers(owner, new SimpleGroupContainerPopulator(memberContainer), controlFactory, configurer);
	}

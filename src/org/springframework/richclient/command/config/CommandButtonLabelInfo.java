...
public class CommandButtonLabelInfo implements ButtonConfigurer {
    ...
    public int hashCode() {
        return labelInfo.hashCode() + (accelerator != null ? accelerator.hashCode() : 0);
    }

    public boolean equals(Object o) {
        if (!(o instanceof CommandButtonLabelInfo)) {
            return false;
        }
        CommandButtonLabelInfo info = (CommandButtonLabelInfo)o;
        return labelInfo.equals(info.labelInfo) && ObjectUtils.nullSafeEquals(accelerator, info.accelerator);
    }
    ...
    protected void configureAccelerator(AbstractButton button, KeyStroke accelerator) {

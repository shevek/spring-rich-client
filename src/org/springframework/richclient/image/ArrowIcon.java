...
public class ArrowIcon implements Icon {
     ...
     * <p>
     * Currently only up and down are supported since this is primarily designed to be a
    ...
    /**
     * Creates a ArrowIcon in the specified direction with the default size
     * and color.
     * 
     ...
     * @param color the color of the arrow (consider using UIDefaults for current L&F)
     */

...
public class WizardDialog extends TitledApplicationDialog implements
    ...
    protected JComponent createTitledDialogContentPane() {
        ...
        Assert.notNull(startPage,
                "No starting page returned; unable to show wizard.");
    ...
    protected Object[] getCommandGroupMembers() {
        if (!wizard.needsPreviousAndNextButtons()) { return super
        ...
        return new AbstractCommand[] { backCommand, nextCommand,
    ...
    protected void onBack() {
        ...
        if (newPage == null || newPage == currentPage) { throw new IllegalStateException(
                "No such page."); }
        showPage(newPage);
    }

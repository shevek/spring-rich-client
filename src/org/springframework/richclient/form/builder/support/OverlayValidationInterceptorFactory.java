 ...
 * The overlaid image is retrieved by the image key
 * "severity.{severityShortCode}.overlay", where {severityShortCode} is
 * the number returned by {@link Severity#getShortCode()}.
 * The image is placed at the bottom-left corner of the component,
 * and the image's tooltip is set to the validation message.
 *
 * @author oliverh

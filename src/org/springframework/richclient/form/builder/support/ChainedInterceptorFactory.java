 ...
 * @author oliverh
 */
public class ChainedInterceptorFactory implements
    ...
    public FormComponentInterceptor getInterceptor(FormModel formModel) {
        ...
        if (interceptors.size() == 0) { return null; }
    ...
    private List getInterceptors(FormModel formModel) {
        ...
        for (Iterator i = interceptorFactories.iterator(); i.hasNext();) {
            FormComponentInterceptor interceptor = ((FormComponentInterceptorFactory)i
                    .next()).getInterceptor(formModel);
            if (interceptor != null) {

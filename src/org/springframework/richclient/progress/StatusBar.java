...
public class StatusBar extends JPanel implements ProgressMonitor {
	...
	private void initialize() {
		...
		Border bevelBorder = BorderFactory.createBevelBorder(BevelBorder.LOWERED, UIManager.getColor("controlHighlight"),
		...
		add(progressBar, cc.xyfi(3, 0, GridBagConstraints.NONE, GridBagCellConstraints.RIGHT_INSETS));
	...
	public void setCancelEnabled(boolean enabled) {
		...
		if (progressBar.isVisible() && !cancelButton.isVisible() && cancelEnabled) {
			showButton();
			revalidate();
		}
	}

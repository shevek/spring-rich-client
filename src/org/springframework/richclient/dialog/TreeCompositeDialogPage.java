...
public class TreeCompositeDialogPage extends CompositeDialogPage {
    ...
    public void addPage(DialogPage parent, DialogPage child) {
        ...
        Assert.notNull(parentNode,
                "Parent dialog page must have been added before child");
    ...
    private JPanel createContentControl() {
        ...
        panelBuilder
                .cell(new JScrollPane(pageTree), "colSpec=150 rowSpec=pref");
        panelBuilder.gapCol();
    ...
    private void createTreeControl() {
        ...
        pageTree.getSelectionModel().setSelectionMode(
    ...
    protected String decoratePageTitle(DialogPage page) {
        return LabelUtils.htmlBlock(page.getTitle()
    ...
    private class PageSelector implements TreeSelectionListener {
        ...
        public void valueChanged(TreeSelectionEvent e) {
            DefaultMutableTreeNode node = (DefaultMutableTreeNode)pageTree

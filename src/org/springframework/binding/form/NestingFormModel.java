...
public interface NestingFormModel extends FormModel {
     ...
     */
    public ConfigurableFormModel createChild(String childFormModelName, String childFormObjectPropertyPath);
     ...
     * @return The child form model
     */
    public NestingFormModel createCompoundChild(String childFormModelName, String childFormObjectPropertyPath);

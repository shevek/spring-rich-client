...
public final class SelectableItemsListModel extends AbstractValueModel
    ...
    private Object getElementAt(Object aList, int index) {
        if (aList == null) { throw new NullPointerException(
                "The list contents is null."); }
        if (aList instanceof ListModel) { return ((ListModel)aList)
                .getElementAt(index); }
    ...
    private int getSize(Object list) {
        ...
        if (list instanceof ListModel) { return ((ListModel)list).getSize(); }
    ...
    public ListModel getListModel() {
        ...
        if (aList == null) { return EMPTY_LIST_MODEL; }
        if (aList instanceof ListModel) { return (ListModel)aList; }
    ...
    public void setSelectionIndex(int newSelectionIndex) {
        if (newSelectionIndex < EMPTY_SELECTION_INDEX
                || newSelectionIndex > getSize())
    ...
    private int indexOf(Object list, Object element) {
        if (element == null || getSize(list) == 0) { return EMPTY_SELECTION_INDEX; }
        if (list instanceof List) { return ((List)list).indexOf(element); }
    ...
    private class SelectableItemsChangeHandler implements ValueChangeListener {
        ...
        private void updateList(Object oldList, Object newList) {
            if (oldList != null && (oldList instanceof ListModel)) {
                ((ListModel)oldList)
                        .removeListDataListener(listDataChangeHandler);
            }
    ...
    private class SelectionChangeHandler implements PropertyChangeListener {
        public void propertyChange(PropertyChangeEvent evt) {
            ...
            fireValueChanged();
            firePropertyChange(SELECTION_EMPTY_PROPERTY,
                    oldSelectionIndex == EMPTY_SELECTION_INDEX,
                    newSelectionIndex == EMPTY_SELECTION_INDEX);
            if (newSelectionIndex == oldSelectionIndex) { return; }
    ...
    private class SelectionIndexChangeHandler implements ValueChangeListener {
        ...
        private void updateSelectionHolderSilently(Object newSelection) {
            selectionHolder
                    .removePropertyChangeListener(selectionChangeHandler);

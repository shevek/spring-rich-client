...
/**
 * Default implementation of ValueChangeDetector. This implementation maintains a set of
 * classes for which it is "safe" to use <code>equals()</code> for detecting a change in
 * value. For all objects of a type in this set, the value comparison will be done using
 * equals. For all other types, object equivalence (the == operator) will be used.
 * 

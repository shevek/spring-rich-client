...
public final class PropertyChangeSupport implements Serializable {
    ...
    public PropertyChangeListener[] getPropertyChangeListeners() {
        ...
        return (PropertyChangeListener[])returnList
                .toArray(new PropertyChangeListener[returnList.size()]);
    }
    ...
    public void firePropertyChange(PropertyChangeEvent evt) {
        ...
        if (ObjectUtils.nullSafeEquals(oldValue, newValue)) { return; }
        ...
        if (listeners != null) {
            ...
            for (int i = 0; i <= listenerList.length - 2; i += 2) {
                if (listenerList[i] == PropertyChangeListener.class) {
                    ((PropertyChangeListener)listenerList[i + 1])
                            .propertyChange(evt);
                }
            }
        }
    ...
    public boolean hasListeners(String propertyName) {
        if (listeners != null
                && listeners.getListenerCount(PropertyChangeListener.class) > 0) {

...
public class ServiceNotFoundException extends RuntimeException {
    ...
    private static String createDefaultMessage(Class serviceClass) {
        ...
        if (serviceClass != null) {
            return "Unable to locate an application service of type ["
    ...
    /**
     * Creates a new {@code ServiceNotFoundException}. A default message containing the name of the
     * given class will be used. 
     *
     * @param serviceClass The class of the application service that could not be located.
     */
    ...
    /**
     * Creates a new {@code ServiceNotFoundException} with the given detail message and nested 
     * exception.
     *
     * @param message The detail message.
     * @param serviceClass The class of the application service that could not be located.
     * @param cause An optional nested exception that occurred attempting to locate the service.
     */

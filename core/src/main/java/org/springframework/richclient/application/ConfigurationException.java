...
/**
 * Indicates that there is a problem with the runtime configuration of the application. This is 
 * a fairly general top-level exception. Before creating and throwing an instance of this type, 
...
public class ConfigurationException extends ApplicationException {
    ...
    /**
     * Creates a new {@code ConfigurationException} with the specified nested exception.
     *
     * @param cause The nested exception.
     */

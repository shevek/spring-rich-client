...
/**
 * 
 * A convenience extension to Spring's {@link org.springframework.util.Assert} class. This 
...
public class Assert1 extends org.springframework.util.Assert {
     ...
     * @param arrayName The property name of the array, only used for display purposes. May be null.
     * 
     * @throws IllegalArgumentException if the given array is null or if any of its elements are null.
     */

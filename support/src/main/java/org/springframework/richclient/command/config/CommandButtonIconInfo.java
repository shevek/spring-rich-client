...
/**
 * A parameter object consisting of the various icons that may be displayed on a single
 * command button depending on its state. 
 * 
 * <p>
...
public class CommandButtonIconInfo implements ButtonConfigurer, VisualizedElement {
    ...
    /**
     * A {@code CommandButtonIconInfo} instance that can be used for command buttons that have no
     * icon information associated with them.
     */
    //FIXME this is a mutable object so we probably shouldn't be reusing the same instance for 
    //a blank IconInfo. What happens if multiple blanks have been dished out and one of them is modified?
    ...
    /**
     * Creates a new {@code CommandButtonIconInfo} with the given icon. No optional icons will
     ...
     * @param selectedIcon The icon to be displayed when the command button is in a selected state.
     * May be null.
     */
     ...
     * @param icon The main default icon. May be null.
     * @param selectedIcon The icon to be displayed when the command button is in a selected state.
     * @param rolloverIcon The icon to be displayed when the mouse pointer rolls over the command
     * button. May be null.
     */
     ...
     * @param rolloverIcon The icon to be displayed when the mouse pointer rolls over the command
     * button. May be null.
     * @param disabledIcon The icon to be displayed when the command button is in a disabled state.
     * May be null.
     * @param pressedIcon The icon to be displayed when the command button is in a pressed state.
     * May be null.
     */
    public CommandButtonIconInfo(Icon icon, 
                                 Icon selectedIcon, 
    ...
    /**
     * Returns the image from the main default icon of this instance if it is actually an instance 
     * of an {@link ImageIcon}.
     * 
     * @return The image from the main default icon, or null if there is no default icon or it
     * is not an {@link ImageIcon}.
     */
     ...
     *
     * @return The icon for the command button when rolled over by the mouse pointer, or null.
     */

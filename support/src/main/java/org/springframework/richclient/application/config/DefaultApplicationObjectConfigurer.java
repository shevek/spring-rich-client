...
public class DefaultApplicationObjectConfigurer implements ApplicationObjectConfigurer, BeanPostProcessor {
    ...
    /** The key fragment used to retrieve the <i>disabled</i> icon for a given object. */
    public static final String DISABLED_ICON_KEY = "disabledIcon";

    /** The key fragment used to retrieve the <i>rollover</i> icon for a given object. */
    public static final String ROLLOVER_ICON_KEY = "rolloverIcon";

    /** The key fragment used to retrieve the <i>selected</i> icon for a given object. */
     ...
     * @param securityControllerManager The security controller manager. May be null.
     */
    public DefaultApplicationObjectConfigurer(MessageSource messageSource, 
     ...
     * {@link CommandIconConfigurable} objects that are configured by this instance. The default 
     * is true.
     *
    ...
    /**
     * Returns this instance's security controller manager. If the security manager was not 
     * provided at construction, it will be retrieved by the application services locator.
     *
     * @return The security controller manager, never null.
     * 
     * @throws ServiceNotFoundException if a security controller manager was not provided at 
     * construction time and the application services locator cannot find an instance of the service.
     */
     ...
     * 
     * <p>
     * This implementation forwards the object to the following overridable methods in the 
     * order listed. Subclasses can use these methods as hooks to modify the default configuration
     ...
     * @param objectName The name for the object, expected to be unique within the application. 
     * If {@code object} is not null, then {@code objectName} must also be non-null.
     * 
     * @throws IllegalArgumentException if {@code object} is not null, but {@code objectName} 
     * is null.
     *  
     */
     ...
     * {@link MessageSource} using a message code in the format <pre>&lt;objectName&gt;.title</pre>
     *
     * @param configurable The object to be configured. Must not be null.
     * @param objectName The name of the configurable object, unique within the application. 
     * Must not be null.
     * 
    ...
    /**
     * Sets the {@link LabelInfo} of the given object. The label info is created after loading the 
     * encoded label string from this instance's {@link MessageSource} using a message code in the 
    ...
    /**
     * Sets the {@link CommandButtonLabelInfo} of the given object. The label info is created 
     * after loading the encoded label string from this instance's {@link MessageSource} using a 
    ...
    /**
     * Sets the description and caption of the given object. These values are loaded from this 
     * instance's {@link MessageSource} using message codes in the format 
     * <pre>&lt;objectName&gt;.description</pre> and <pre>&lt;objectName&gt;.caption</pre> respectively.
     *
     * @param configurable The object to be configured. Must not be null.
     * @param objectName The name of the configurable object, unique within the application. 
     * Must not be null.
     ...
     * {@link ImageSource} using a key in the format <pre>&lt;objectName&gt;.image</pre> If the image source
     * cannot find an image under that key, the object's image will be set to null.
     *
     * @param configurable The object to be configured. Must not be null.
     * @param objectName The name of the configurable object, unique within the application. 
     * Must not be null.
     ...
     * {@link IconSource} using a key in the format <pre>&lt;objectName&gt;.icon</pre> If the icon source
     * cannot find an icon under that key, the object's icon will be set to null.
     *
     * @param configurable The object to be configured. Must not be null.
     * @param objectName The name of the configurable object, unique within the application. 
     * Must not be null.
    ...
    /**
     * Sets the icons of the given object. The icons are loaded from this instance's 
     * {@link IconSource}.  using a key in the format <pre>&lt;objectName&gt;.icon</pre> If the icon source
     * cannot find an icon under that key, the object's icon will be set to null.
     *
     * @param configurable The object to be configured. Must not be null.
    ...
    /**
     * Sets the icons for the given object by retrieving them from this instance's 
     * {@link IconSource} and adding them to the {@link CommandButtonIconInfo} object to be set 
     * on the configurable object. 
     * 
     * <p>
     * The keys used to retrieve icons from the icon source are created by concatenating the given 
     * {@code objectName} with a dot (.) and then an icon type like so: 
     * </p>
     * 
     * <pre>    {@code myObjectName.someIconType}.</pre>
     * 
     * If the {@code loadOptionalIcons} flag is set to true (it is by default) all the following 
     * icon types will be used. If the flag is false, only the first will be used:
     * 
     * <ul>
    ...
    /**
     * Sets the large icons for the given object by retrieving them from this instance's 
     * {@link IconSource} and adding them to the {@link CommandButtonIconInfo} object to be set 
     * on the configurable object. 
     * 
     * <p>
     * The keys used to retrieve icons from the icon source are created by concatenating the given 
     * {@code objectName} with a dot (.), the text 'large' and then an icon type like so: 
     * </p>
     * 
     * <pre>    {@code myObjectName.large.someIconType}.</pre>
     * 
     * If the {@code loadOptionalIcons} flag is set to true (it is by default) all the following 
     * icon types will be used. If the flag is false, only the first will be used:
     * 
     ...
     * {@link MessageSource} and locale.
     *
     * @param messageCode The message code that will be used to retrieve the message. Must not be null.

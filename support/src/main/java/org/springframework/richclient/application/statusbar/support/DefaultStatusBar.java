 ...
 */
public class DefaultStatusBar extends AbstractControlFactory implements
		StatusBar {
	 ...
	 * 
	 * @param message
	 *            the message to be set, if <code>null</code>, the status
	 *            line is cleared.
	 */
	 ...
	 * 
	 * @param message
	 *            the error message to be set, if <code>null</code>, the
	 *            error message is cleared, and the standard message is shown
	 *            again
	 */

 ...
 * <p>
 * By default, a {@link WritableTableFormat} will be generated for this model. If you want to change this, you can
 * override the {@link #createTableFormat()} method to provide your own format. In addition, an implementation of an
 * {@link AdvancedTableFormat} is provided for use. It allows for the specification of an object prototype (for
...
public class GlazedTableModel extends EventTableModel {
     ...
     * <p>
     * You can specify individual comparators for columns using {@link #setComparator(int, Comparator)}. For any column

 ...
 * It is intended to highlight the common models for working with the platform (including
 * configuration and runtime access to platform services) and how to organize the basic
 * pieces of an application using the platform.
 * <p>
 * This sample provides an implementation of a&nbsp;<em>trivial</em> address book.
 * Trust me when I say trivial :-) It has no persistence, no security, and no complex
 * business logic. The focus of the sample is how to work with the Spring Rich platform,
 * not about how to build a great address book.
 * <p>
 * Other samples will introduce more complex topics like user management (security),
 * alternate page/view layouts, complex data binding, remoting, etc.
 * <p>

...
public class ContactTable extends AbstractObjectTable {
     ...
     * sample. You would normally access a persistent store, or some other source to get
     * the data for the table.
     */
    protected Object[] getDefaultInitialData() {
        return getContactDataStore().getAllContacts();
    }

    /*
     * (non-Javadoc)
     * 
     * @see org.springframework.richclient.samples.simple.ui.AbstractObjectTable#configureTable(javax.swing.JTable)
     */

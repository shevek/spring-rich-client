...
/**
 * This class is a source for validation rules associated with the domain objects in this
 * application. This clas is wired into application via the application context
 ...
 * </pre>
 * 
 * With this configuration, validating forms will interrogate the rules source for rules
 * that apply to the class of a form object (in this case, that's objects of type
 * {@link Contact}.
 * 
...
public class SimpleValidationRulesSource extends DefaultRulesSource {
    ...
    /**
     * Basic name validator. Note that the "alphabeticConstraint" argument is a message
     * key used to locate the message to display when this validator fails.
     */
    ...
    /**
     * Construct the rules source. Just add all the rules for each class that will be
     * validated.
     */

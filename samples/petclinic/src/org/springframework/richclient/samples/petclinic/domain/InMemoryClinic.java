...
public class InMemoryClinic extends HsqlJdbcClinic {
    ...
    protected void initDao() {
        ...
        template
                .execute("CREATE TABLE specialties (id INT NOT NULL IDENTITY PRIMARY KEY, name VARCHAR(80))");

        template
                .execute("CREATE TABLE vet_specialties (vet_id INT NOT NULL, specialty_id INT NOT NULL)");
        template
        ...
        template
                .execute("CREATE TABLE types (id INT NOT NULL IDENTITY PRIMARY KEY, name VARCHAR(80))");
        template
        ...
        template
                .execute("alter table pets add constraint fk_pets_owners foreign key (owner_id) references owners(id)");
        template
                .execute("alter table pets add constraint fk_pets_types foreign key (type_id) references types(id)");
        ...
        template
                .execute("alter table visits add constraint fk_visits_pets foreign key (pet_id) references pets(id)");
        ...
        template
                .execute("CREATE TABLE authorities (username VARCHAR(50) NOT NULL, authority VARCHAR(50) NOT NULL)");
        template
        ...
        template
                .execute("INSERT INTO owners VALUES (7, 'Peter', 'Black', '1450 Oak Blvd.', 'Monona', '6085555387');");
        template
        ...
        template
                .execute("INSERT INTO pets VALUES (1, 'Leo', '2000-09-07', 1, 1)");
        template
                .execute("INSERT INTO pets VALUES (2, 'Basil', '2002-08-06', 6, 2)");
        template
                .execute("INSERT INTO pets VALUES (3, 'Rosy', '2001-04-17', 2, 3)");
        template
                .execute("INSERT INTO pets VALUES (4, 'Jewel', '2000-03-07', 2, 3)");
        template
                .execute("INSERT INTO pets VALUES (5, 'Iggy', '2000-11-30', 3, 4)");
        template
                .execute("INSERT INTO pets VALUES (6, 'George', '2000-01-20', 4, 5)");
        template
                .execute("INSERT INTO pets VALUES (7, 'Samantha', '1995-09-04', 1, 6)");
        template
                .execute("INSERT INTO pets VALUES (8, 'Max', '1995-09-04', 1, 6)");
        template
                .execute("INSERT INTO pets VALUES (9, 'Lucky', '1999-08-06', 5, 7)");
        template
                .execute("INSERT INTO pets VALUES (10, 'Mulligan', '1997-02-24', 2, 8)");
        template
                .execute("INSERT INTO pets VALUES (11, 'Freddy', '2000-03-09', 5, 9)");
        template
                .execute("INSERT INTO pets VALUES (12, 'Lucky', '2000-06-24', 2, 10)");
        template
                .execute("INSERT INTO pets VALUES (13, 'Sly', '2002-06-08', 1, 10)");

        template
                .execute("INSERT INTO visits VALUES (1, 7, '1996-03-04', 'rabies shot')");
        template
                .execute("INSERT INTO visits VALUES (2, 8, '1996-03-04', 'rabies shot')");
        template
                .execute("INSERT INTO visits VALUES (3, 8, '1996-06-04', 'neutered')");
        template
                .execute("INSERT INTO visits VALUES (4, 7, '1996-09-04', 'spayed')");
        ...
        template
                .execute("INSERT INTO authorities VALUES ('marissa', 'ROLE_CLINIC_STAFF')");
        template
                .execute("INSERT INTO authorities VALUES ('dianne', 'ROLE_CLINIC_STAFF')");
        template
                .execute("INSERT INTO authorities VALUES ('peter', 'ROLE_CLINIC_CUSTOMER')");
        template
                .execute("INSERT INTO authorities VALUES ('scott', 'ROLE_CLINIC_CUSTOMER')");
    }

    public Collection findOwners(String arg0) throws DataAccessException {
        Collection result = super.findOwners(arg0);
        logger.debug("Finding Owners matching: " + arg0 + "; found: "
                + result.size());
        return result;
    }

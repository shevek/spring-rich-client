...
/**
 * Indicatets that the initialization of an object has not set a required property. 
 *
...
public class PropertyNotSetException extends ConfigurationException {
    ...
    /**
     * Creates a new {@code PropertyNotSetException} with the 
     * specified bean class and property name.
     *
     * @param beanClass The class of the JavaBean that has an uninitialized property.

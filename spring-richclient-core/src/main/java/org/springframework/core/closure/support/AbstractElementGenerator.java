...
public abstract class AbstractElementGenerator implements ElementGenerator {
     ...
     * 
     * @param runOnce
     *            <code>true</code> if this ElementGenerator may only be run
     ...
     *             if this ElementGenerator was a runOnce instance.
     */
	...
	private static class WhileTrueController extends Block {
         ...
         * 
         * @param template
         *            the ElementGenerator that spawns the elements and that
         *            will be stopped if an object fails the constraint.
         * @param constraint
         *            the constraint to test against.
         */
	...
	private static class UntilTrueController extends Block {
         ...
         * 
         * @param template
         *            ElementGenerator that spawns the elements and that will be
         *            stopped if the constraint returns true.
         * @param templateCallback
         *            Closure-code executed on each passed object.
         * @param constraint
         *            constraint that will stop the ElementGenerator if
         *            returning true.
         */
	...
	private static class ObjectFinder extends Block {
         ...
         * 
         * @param generator
         *            the generator which spawns the elements and that must be
